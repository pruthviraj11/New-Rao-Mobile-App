            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border rounded-3">
                        ...
                        <a href="{{ route('app-roles-list') }}" class="btn-sm btn btn-primary float-end">Role List</a>
                                                        ...
                                                        <div class="row">
                                                            @foreach ($permissions as $value)
                                                                <div class="col-md-2 mb-2">
                                                                    <label>{{ Form::checkbox('permissions[]', $value->id, !empty($rolePermissions) && in_array($value->id, $rolePermissions) ? true : false, ['class' => 'name']) }}
