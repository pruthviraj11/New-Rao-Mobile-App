            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border rounded-3">
                        ...
                        <a href="{{ route('app-faq-list') }}" class="btn-sm btn btn-primary float-end">Faq
                            List</a>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="col-md-12 col-sm-12 mb-1">
                                        ...
                                        <div class="form-check form-check-success form-switch">
                                            <input type="checkbox" name="status"
                                                {{ $faq != '' && $faq->status ? 'checked' : '' }} class="form-check-input"
                                                id="customSwitch4" @if (empty($faq)) checked @endif />
                                        </div>
                                        <span class="text-danger">
                                            @error('status')
                                                {{ $message }}
