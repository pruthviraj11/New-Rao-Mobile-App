            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('app-our-services-list') }}" class="col-md-2 btn btn-primary float-end">Our
                            Services
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 mb-1">
                                ...
                                <input type="text" id="contact_no" class="form-control" placeholder="Contact Number" name="contact_no" value="{{ old('contact_no') ?? ($ourServices ? $ourServices->contact_no : '') }}">
                                <span class="text-danger">
                                    @error('contact_no')
                                        {{ $message }}
                                    @enderror
