...
@section('content')
    ...
    @if ($page_data['page_title'] == 'Events Add')
        <form action="{{ route('app-events-store') }}" method="POST" enctype="multipart/form-data">
            @csrf
        @else
            <form action="{{ route('app-events-update', encrypt($events->id)) }}" method="POST"
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('app-events-list') }}" class="col-md-2 btn btn-primary float-end">Events
                            List</a>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-sm-12 mb-1">
                                ...
                                <input type="text" id="title" class="form-control" placeholder="title" name="title"
                                    value="{{ old('title') ?? ($events ? $events->title : '') }}">
