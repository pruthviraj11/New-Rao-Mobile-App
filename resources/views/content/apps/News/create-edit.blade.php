            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('app-news-list') }}" class="col-md-2 btn btn-primary float-end">News
                            List</a>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-sm-12 mb-1">
                                ...
                                <input type="text" id="title" class="form-control" placeholder="title" name="title"
                                    value="{{ old('title') ?? ($news ? $news->title : '') }}">
                            ...
                            <div class="col-md-6 col-sm-12 mb-1">
                                ...
                                <input type="date" id="date" class="form-control datepicker" name="date"
                                    value="{{ old('date') ?? ($news ? $news->date : '') }}" placeholder="YYYY-MM-DD">
                                <span class="text-danger">
                                    @error('date')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-md-6 col-sm-12 mb-1">
                                ...
                                <input type="text" id="news_button_text" class="form-control" placeholder="news button text" name="news_button_text"
                            ...
                            <div class="col-md-6 col-sm-12 mb-1">
                                ...
                                <div class="form-check form-check-success form-switch">
                                    <input type="checkbox" name="status"
                                        {{ $news != '' && $news->status ? 'checked' : '' }} class="form-check-input"
                                        id="customSwitch4" @if (empty($news)) checked @endif />
                                </div>
                                <span class="text-danger">
                                    @error('status')
                                        {{ $message }}
