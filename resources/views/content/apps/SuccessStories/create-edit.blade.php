            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border">
                        ...
                        <a href="{{ route('app-success-stories-list') }}" class="btn-sm btn btn-primary float-end">Success
                            Stories List</a>
                    </div>

                    <div class="card-body">
                        <div class="card my-1 border rounded-3">
                            <div class="card-header border">
                                <h6 class="">{{ $page_data['form_title'] }}</h6>
                            </div>
                            <div class="card-body mt-1">
                                <div class="row">
                                    <!-- File Upload Field -->
                                    <div class="col-md-12 col-sm-12 mb-1">
                                        <label class="form-label" for="file">Client Image</label>
                                    ...
                                    <div class="col-md-12 col-sm-12 mb-1">
                                        ...
                                        <input type="text" id="candidate_name" class="form-control"
                                            placeholder="Candidate Name" name="candidate_name"
                                    ...
                                    <div class="col-md-12 col-sm-12 mb-1">
                                        ...
                                        <input type="file" id="candidate_image" class="form-control"
                                            placeholder="Candidate Image URL" name="candidate_image"
                                    ...
                                    <div class="col-md-12 col-sm-12 mb-1">
                                        ...
                                        <input type="file" id="video_thumbnail" class="form-control"
                                            placeholder="Video Thumbnail URL" name="video_thumbnail"
                                    ...
                                    <div class="col-md-12 col-sm-12 mb-1">
                                        ...
                                        <input type="text" id="candidate_type" class="form-control"
                                            placeholder="Candidate Type" name="candidate_type"
                                    ...
                                    <div class="col-md-12 col-sm-12 mb-1">
                                        ...
                                        <input type="text" id="ratings" class="form-control" placeholder="Ratings"
                                            name="ratings"
