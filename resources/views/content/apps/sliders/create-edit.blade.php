            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('app-sliders-list') }}" class="col-md-2 btn btn-primary float-end">Slider
                            List</a>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-sm-12 mb-1">
                                <label class="form-label" for="name-column">
                                    Name</label>
                                <input type="text" id="name" class="form-control" placeholder="Name Of Slider"
                                    name="name" value="{{ old('name') ?? ($slider ? $slider->name : '') }}">
                            ...
                            <div class="col-md-6 col-sm-12 mb-1">
                                <label class="form-label" for="name-column">
                                    Sequence</label>
                                <input type="number" id="sequence" class="form-control" placeholder="Number Of Sequence"
                                    name="sequence" value="{{ old('sequence') ?? ($slider ? $slider->sequence : '') }}">
                                <span class="text-danger">
                                    @error('sequence')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-md-6 col-sm-12 mb-1">
                                ...
                                <div class="form-check form-check-success form-switch">
                                    <input type="checkbox" name="status"
                                        {{ $slider != '' && $slider->status ? 'checked' : '' }} class="form-check-input"
                                        id="customSwitch4" @if (empty($slider)) checked @endif />
                                </div>
                                <span class="text-danger">
                                    @error('status')
                                        {{ $message }}
