    ...
    <section class="app-user-list">
        ...
        <div class="card">
            <div class="card-header border rounded-3">
                <h4 class="card-title">Client Type List</h4>
                <div>
                    <a href="{{ route('app-client-types-add') }}" class="btn-sm btn btn-primary">Add Client Type</a>
                ...
                <div class="card border mt-1">
                    <div class="card-body">
                        <div class="card-datatable table-responsive pt-0">
                            <table class="user-list-table table dt-responsive" id="client-types-table">
                                <thead>
                                    <tr>
...
@section('page-script')
    <script>
        $(document).ready(function() {
            let selectedIds = [];
            $('#client-types-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('app-client-types-get-all') }}",
                columns: [{
                        data: null,
                        orderable: false,
                        searchable: false,
            ...
            $('#delete-selected').on('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: '{{ route('app-client-types-destroy') }}', // Update to your delete endpoint
                            method: 'POST',
                            data: {
                                ids: selectedIds,
                            ...
                            success: function(response) {
                                ...
                                $('#client-types-table').DataTable().ajax
        ...
        $(document).on("click", ".confirm-delete", function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    window.location.href = '/app/sliders/destroy/' + id;
                    Swal.fire({
                        icon: 'success',
                        title: 'Deleted!',
