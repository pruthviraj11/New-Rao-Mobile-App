                            ...
                            <div class="card-body mt-1">
                                <div class="row">
                                    ...
                                    <div class="row">
                                                ...
                                                @if (!empty($homeService->file))
                                                    <button type="button"
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            ...
                                                            stroke-linejoin="round" class="feather feather-trash-2 ficon">
                                        ...
                                        <div class="col-md-9">
                                            <label class="form-label mb-1" for="file">Icons</label>
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <input type="file" id="service_image" class="form-control"
                                                name="service_image" accept="service_image/*">
                                            <span class="text-danger">
                                                @error('service_image')
                                                    {{ $message }}
                                                @enderror
