            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('app-application-statuses-list') }}" class="col-md-2 btn btn-primary float-end">Slider
                            List</a>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 mb-1">
                                ...
                                <input type="number" id="order" class="form-control" placeholder="Order" name="order"
                            ...
                            <div class="col-md-6 col-sm-12 mb-1">
                                ...
                                <select id="category" class="form-control" name="category">
                                    ...
                                    <option value="FE" {{ old('category') == 'FE' || ($applicationStatuses && $applicationStatuses->category == 'FE') ? 'selected' : '' }}>FE</option>
                                    <option value="IV" {{ old('category') == 'IV' || ($applicationStatuses && $applicationStatuses->category == 'IV') ? 'selected' : '' }}>IV</option>
                                    <option value="ALL" {{ old('category') == 'ALL' || ($applicationStatuses && $applicationStatuses->category == 'ALL') ? 'selected' : '' }}>ALL</option>
                                </select>
                                <span class="text-danger">
                                    @error('category')
                                        {{ $message }}
