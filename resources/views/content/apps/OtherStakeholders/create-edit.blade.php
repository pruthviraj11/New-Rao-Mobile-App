            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('app-our-services-list') }}" class="col-md-2 btn btn-primary float-end">Other
                            Stakeholders
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            {{-- <div class="col-md-6 col-sm-12 mb-1">
                                ...
                                <select id="user_id" class="form-control" name="user_id">
                                    ...
                                    @foreach($users as $user)
                                        <option value="{{ $user->id }}" {{ (old('user_id') ?? ($otherStakeholders ? $otherStakeholders->user_id : '')) == $user->id ? 'selected' : '' }}>
                                            {{ $user->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 col-sm-12 mb-1">
                                ...
                                <select id="attached_user_id" class="form-control" name="attached_user_id">
                                    ...
                                    @foreach($advisors as $advisor)
                                        <option value="{{ $advisor->id }}" {{ (old('attached_user_id') ?? ($otherStakeholders ? $otherStakeholders->attached_user_id : '')) == $advisor->id ? 'selected' : '' }}>
                                            {{ $advisor->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 col-sm-12 mb-1">
                                ...
                                <select id="role_name" class="form-control" name="role_name">
                                    ...
                                    <option value="Application Advisor(FE)" {{ (old('role_name') ?? ($otherStakeholders ? $otherStakeholders->role_name : '')) == 'Application Advisor(FE)' ? 'selected' : '' }}>
                                        Application Advisor (FE)
                                    </option>
                                    <option value="Visa Advisor" {{ (old('role_name') ?? ($otherStakeholders ? $otherStakeholders->role_name : '')) == 'Visa Advisor' ? 'selected' : '' }}>
                                        Visa Advisor
                                    </option>
                                </select>
                                <span class="text-danger">
